  ...
  theme: {
    extend: {
      ...
      typography: (theme) => ({
        DEFAULT: {
          css: {
            // Color all <a> tags blue, with an underline and a darker hover state
            a: {
            ...
            'a::after': {
              ...
              marginLeft: theme('spacing.1'), // 0.25rem (snugger than 0.5rem)
              verticalAlign: 'middle',        // center against text
              mask: `url("data:image/svg+xml;utf8,${encodeURIComponent(`
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                  ...
                  <path fill-rule="evenodd" d="…your path…" clip-rule="evenodd"/>
                </svg>

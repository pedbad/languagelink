...
class BookingAdmin(admin.ModelAdmin):
    list_display = ('student', 'teacher', 'date', 'start_time', 'end_time', 'booked_at')
    list_filter = ('teacher_availability__date',)
    search_fields = ('student__first_name', 'student__last_name', 'teacher_availability__teacher__first_name', 'teacher_availability__teacher__last_name')

    def teacher(self, obj):
        return obj.teacher_availability.teacher.get_full_name()  # Display teacher's full name

...
Instead see settings directoty for local and prod settings
manage.py, and wsgi and asgi have been refactored too.

Check which settings module Django is using:
python manage.py diffsettings | head -n 20
